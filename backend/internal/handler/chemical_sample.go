...
type ChemicalSampleHandler struct{ service service.ChemicalSampleService }

func NewChemicalSampleHandler(s service.ChemicalSampleService) *ChemicalSampleHandler {
	return &ChemicalSampleHandler{service: s}
}

func (h *ChemicalSampleHandler) Register(group *gin.RouterGroup) {
...
func (h *ChemicalSampleHandler) list(c *gin.Context) {
	query := bindPage(c)
...
func (h *ChemicalSampleHandler) get(c *gin.Context) {
	id, ok := parseID(c)
	if !ok {
		return
	}
...
func (h *ChemicalSampleHandler) create(c *gin.Context) {
	var input dto.CreateChemicalSample
...
func (h *ChemicalSampleHandler) update(c *gin.Context) {
	id, ok := parseID(c)
	if !ok {
		return
	}
	var input dto.UpdateChemicalSample
	if err := c.ShouldBindJSON(&input); err != nil {
		util.Fail(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	}
...
func (h *ChemicalSampleHandler) transition(c *gin.Context) {
	id, ok := parseID(c)
	if !ok {
		return
	}
...
func (h *ChemicalSampleHandler) remove(c *gin.Context) {
